...
export const translations: Record<Language, TranslationKeys> = {
  pt: {
    ...
    verifySubtitle: "Introduza o código de 5 dígitos enviado para o seu email.",
    ...
    libraryInfo: "Biblioteca da UA • UA",
    settings: "Definições",
    logout: "Sair",
  ...
  en: {
    ...
    verifySubtitle: "Enter the 5-digit code sent to your email.",
